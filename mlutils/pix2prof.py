#TODO update galaxy and profile pipeline for RA and ellip 
#TODO get a pa pipeline hook working for train/test/eval
"""
CNN stem to RNN classifier for galaxy profile fitting.
"""
import numpy as np
import glob
